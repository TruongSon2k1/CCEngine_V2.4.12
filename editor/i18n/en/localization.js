    ...
    'COMPONENT': {
        ...
        'physics': {
            'rigidbody': {
                ...
                'sync_rotation' : '- Alway sync the rotation of this rigidbody in its `update` function.\n- This will fix the error that make rigid body go wrong rotation after resizing the game window.\n\n[LOW PERFORMANCE WARNING]',
                'sync_position' : '- Alway sync the position of this rigidbody in its `update` function.\n- This will fix the error that make rigid body go wrong position after resizing the game window.\n\n[LOW PERFORMANCE WARNING]',
            },
            'physics_collider': {
                'density': 'The density',
